...
<div class="mod_wow_latest_guid_achievements<?php echo $params->get('moduleclass_sfx'); ?>">
    <ul>
        <?php foreach ($achievements as $row) { ?>
            <li title="<?php echo $row->desc; ?>"><a href="http://de.wowhead.com/achievement=<?php echo $row->av; ?>" target="_blank"><img src="<?php echo $row->icon; ?>" width="18" height="18" alt="" /></a> <a href="http://de.wowhead.com/achievement=<?php echo $row->av; ?>" target="_blank"><?php echo $row->desc; ?></a></li>
        <?php } ?>
    </ul>
</div>
